...
SearchResult Search::Astar(Map &map)
{
    ...
    while(!open.empty())
    {
        ...
        while (it2!=successors.end())
        {
            ...
            {
                list <Node> :: iterator it_open = find(open.begin(), open.end(), temp);
                Node o = *it_open;

                if (find(open.begin(), open.end(), temp)!=open.end() && temp.g <= o.g)
                {
                    o.g = temp.g;
                    o.f = o.g + o.h;
                    o.parent = &temp;
                ...
                else if (find(open.begin(), open.end(), temp)==open.end())
                {
